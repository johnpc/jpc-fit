...
import { createQuickAdd } from "./graphql/mutations";
const client = generateClient();
export default function QuickAddCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createQuickAdd.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "QuickAddCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
