...
import { createWeight } from "./graphql/mutations";
const client = generateClient();
export default function WeightCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setCurrentWeight(initialValues.currentWeight);
    setErrors({});
  };
  const validations = {
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createWeight.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "WeightCreateForm")}
      {...rest}
    >
      <TextField
